...
11. Create a User environment variable for the robot name. Set the variable `RobotName` to the name of the robot. This should allow the keyboard binding and tasks to recognize the robot by name.
